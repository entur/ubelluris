...
class QuayModeMatcherTest {
    ...
    fun shouldNotMatchWhenInvalidRefFormat() {
        val scheduledStopPointRefs = mapOf("INVALID" to setOf(TransportMode.TRAM))
    ...
    fun shouldHandleQuayWithNoMatch() {
        val scheduledStopPointRefs = mapOf("1:999" to setOf(TransportMode.TRAM))
    ...
    fun shouldHandleQuayWithoutKeyValues() {
        val scheduledStopPointRefs = mapOf("1:001" to setOf(TransportMode.TRAM))
